...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden" ng-controller="addBug" ng-cloak>
    ...
    <ul class="nav navbar-nav ml-auto">
      <li  class="breadcrumb-menu d-md-down-none margin-15t margin-10r" ng-if="operationType == 'edit'">
                    ...
                    <div class="animated fadeIn">
                       <div class="container-fluid">
                        <div class="row">
                                ...
                                <div class="form-group">
                                  <div class="row">
                                    <div class="col-md-3" class="form-group">
                                        <span for="title" class="view-title">Bug Id:</span><br>
                                        <input type="hidden"  name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden"  ng-model="bug.bug_code"  disabled class="form-control">
                                       BG - @{{bug.bug_code}}
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="severity" ng-model='bug.severity_id' name="severity" ng-class="{true: 'error'}[submitted && bugForm.severity.$invalid]" convert-to-number class="form-control" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select id="status" name="status" ng-model='bug.status_id' ng-class="{true: 'error'}[submitted && bugForm.status.$invalid]" convert-to-number class="form-control"  required>
                            ...
                            <div class="col-md-12" ng-hide="operationType == 'view'">                            
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
